...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("x_JANIYAzz")[1];
    if (!base64Data) {
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94787878306@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          ...
          externalAdReply: {
            ...
            thumbnailUrl:
              "https://raw.githubusercontent.com/RASH-DATA/ANJU-DATA/refs/heads/https://pin.it/1bDjmtg2H", // This should match the image URL provided above
